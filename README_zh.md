...
| 排名 | 模型 | 01 | 02 | 03 | 04 | 05 | 06 | 07 | 08 | 09 | 10 | 總分 | 時間 | Token 數 | Tok/分 |
|------|------|----|----|----|----|----|----|----|----|----|----|------|------|---------|--------|
...
> **備註：** 所有模型皆透過 OpenRouter 免費端點測試。Tok/分 = 每得一分所需 Token 數（越低越高效）。
...
> 基於 OpenRouter 公開定價估算每次完整測試（10 項）的費用。按每分費用排序（越低越划算）。

| 排名 | 模型 | 分數 | 估算費用 | 每分費用 | Token 數 | 性價比 |
|------|------|------|---------|---------|---------|--------|
| 1 | openai/gpt-oss-120b | 22/30 | $0.010 | $0.0005 | 153K | 最佳 |
| 2 | openai/gpt-oss-20b | 14/30 | $0.010 | $0.0007 | 142K | 最佳 |
| 3 | qwen/qwen3-coder-next | 20/30 | $0.072 | $0.0036 | 467K | 最佳 |
| 4 | google/gemini-3-flash | 25/30 | $0.093 | $0.0037 | 107K | 優秀 |
| 5 | qwen/qwen3.5-27b | 25/30 | $0.099 | $0.0040 | 262K | 優秀 |
| 6 | qwen/qwen3-coder-30b | 26/30 | $0.109 | $0.0042 | 1420K | 優秀 |
| 7 | qwen/qwen3.5-35b | 22/30 | $0.097 | $0.0044 | 355K | 優秀 |
| 8 | minimax/minimax-m2.1 | 24/30 | $0.121 | $0.0050 | 368K | 優秀 |
| 9 | qwen/qwen3-coder | 24/30 | $0.126 | $0.0053 | 469K | 良好 |
| 10 | minimax/minimax-m2.5 | 19/30 | $0.107 | $0.0056 | 300K | 良好 |
| 11 | **qwen/qwen3-coder-flash** | **30/30** | $0.183 | $0.0061 | 780K | 良好 |
| 12 | moonshotai/kimi-k2.5 | 27/30 | $0.174 | $0.0064 | 258K | 良好 |
| 13 | qwen/qwen3.5-122b | 23/30 | $0.229 | $0.0100 | 579K | 尚可 |
| 14 | z-ai/glm-4.7 | 23/30 | $0.276 | $0.0120 | 570K | 尚可 |
| 15 | z-ai/glm-5 | 26/30 | $0.314 | $0.0121 | 354K | 尚可 |
| 16 | qwen/qwen3.5-397b | 20/30 | $0.290 | $0.0145 | 546K | 偏貴 |
| 17 | moonshotai/kimi-k2 | 14/30 | $0.524 | $0.0374 | 808K | 偏貴 |
| 18 | anthropic/claude-haiku-4.5 | 27/30 | $2.583 | $0.0957 | 1955K | 偏貴 |

**最佳甜蜜點：** Gemini 3 Flash（25/30，$0.09）和 qwen3.5-27b（25/30，$0.10）在高分與低費用之間取得最佳平衡。滿分的 qwen3-coder-flash 每次測試僅需 $0.18。

**Claude Haiku 悖論：** 得分 27/30 但費用高達 $2.58 — 比 Gemini Flash 貴 28 倍，卻只多 2 分。其 190 萬 Token 消耗（主要來自冗長的多輪對話）使其成為測試中性價比最低的模型。
